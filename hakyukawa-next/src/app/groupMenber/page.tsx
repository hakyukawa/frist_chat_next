                    ...
                    <div key={users.id} className="flex justify-between">
                        ...
                        {users.userId === owner_id ? (
                            <div className="flex justify-center items-center ">
                                <p className="bg-main p-[5px] rounded-[40px] text-background font-bold">オーナー</p>
                            </div>
                        ) : (
                            <button onClick={() => deleteUser(users.userId)} type="button" className="flex justify-center items-center">
